...
#         return "File not found", 404
#
# # Alternative: Serve ads.txt as a string if you prefer
# @app.route('/robots.txt')
# def robots_txt():
#     """
#     Serve robots.txt for search engine crawlers.
...
#     return robots_content, 200, {'Content-Type': 'text/plain; charset=utf-8'}
#
# # OPTIONAL: Add sitemap route for SEO (future enhancement)
# @app.route('/sitemap.xml')
# def sitemap():
#     """
#     Generate sitemap for search engines.
#     This helps Google index your content better.
#     """
#     from flask import Response
#
#     # Simple sitemap - you can enhance this later
#     sitemap_xml = '''<?xml version="1.0" encoding="UTF-8"?>
# <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
#     <url>
#         <loc>https://peanutlife.com/</loc>
